...
//first param : connection string; second param: mongodb config property, third param: the action on
mongodb.connect(connectionString,{b},(err,client)=>{
db=client.db() //this selects our mongodb databes
app.listen(3000)
