...
let connectionString='mongodb+srv://todoappuser:todoappuser@cluster0-to-do.b5gol.mongodb.net/TodoApp?retryWrites=true&w=majority'

//first param : connection string; second param: mongodb config property, third param: the action in the method

mongodb.connect(connectionString,{useNewUrlParser:ture},(err,client)=>{
