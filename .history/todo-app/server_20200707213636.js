    ...
    <body>
      <div class="container">
        ...
        <ul class="list-group pb-5">
          ${items.map(function(azAdat){
            return`<li class="list-group-item list-group-item-action d-flex lign-items-center justify-content-between">
            <span class="item-text">${azAdat}</span>
            <div>
