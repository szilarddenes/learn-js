...
app.use(express.static('todo-app/public')) //inviting static files to execute in our environment --will make available the content of this folder for the users
  ...
  db.collection('items')
    ...
    <body>
      <div class="container">
        ...
        <h2 class="display-4 text-center py-1">nodemon works</h2>
      ...
      <script src="todo-app/public/browser.js"></script>
    </body>
    </html>`)
      //end html
    })
